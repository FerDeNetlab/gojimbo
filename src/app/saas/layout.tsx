                ...
                <div className="h-full flex flex-col">
                    ...
                    <nav className="flex-1 p-4 space-y-1">
                        ...
                        <div className="pt-4 mt-4 border-t border-jimbo-border">
                            <Link href="/netlab" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-jimbo-accent hover:bg-jimbo-accent/10 transition-all duration-200 text-sm font-medium">
            ...
            <div className="flex-1 flex flex-col min-h-screen">
                <header className="h-16 border-b border-jimbo-border flex items-center justify-between px-6">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/netlab" className="text-xs text-jimbo-accent border border-jimbo-accent/30 px-3 py-1.5 rounded-lg hover:bg-jimbo-accent/10 transition">
                            Panel Producto
                        </Link>
                    </div>
                </header>
